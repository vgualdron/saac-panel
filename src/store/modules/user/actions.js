...
export default {
  ...
  async [types.actions.LIST_USERS_OPTIONS]({ commit }, payload) {
    try {
      const response = await userApi.list(payload);
      commit(types.mutations.SET_STATUS, true);
      commit(types.mutations.SET_USERS_OPTIONS, response.data.data);
    } catch (error) {
      commit(types.mutations.SET_STATUS, false);
      if (error.message !== 'Network Error') {
        commit(types.mutations.SET_RESPONSE_MESSAGES, error.response.data.message);
  ...
  async [types.actions.LIST_USERS_BY_AREA]({ commit }, payload) {
    try {
      const response = await userApi.listByArea(payload);
      commit(types.mutations.SET_STATUS, true);
      commit(types.mutations.SET_USERS, response.data.data);
    } catch (error) {
      commit(types.mutations.SET_STATUS, false);
  ...
  async [types.actions.UPDATE_LOCATION]({ commit }, payload) {
    try {
      const response = await userApi.updateLocation(payload);
      commit(types.mutations.SET_STATUS, true);
      commit(types.mutations.SET_RESPONSE_MESSAGES, response.data.message);
    } catch (error) {
      commit(types.mutations.SET_STATUS, false);
  ...
  async [types.actions.COMPLETE_DATA]({ commit }, payload) {
    try {
      const response = await userApi.completeData(payload);
      commit(types.mutations.SET_STATUS, true);
      commit(types.mutations.SET_RESPONSE_MESSAGES, response.data.message);
    } catch (error) {
      commit(types.mutations.SET_STATUS, false);
